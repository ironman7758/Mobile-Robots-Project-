...
typedef struct _SendSms_SendGoal_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SendSms_SendGoal_Event_type_support_ids_t;

static const _SendSms_SendGoal_Event_type_support_ids_t _SendSms_SendGoal_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _SendSms_SendGoal_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SendSms_SendGoal_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SendSms_SendGoal_Event_type_support_symbol_names_t _SendSms_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_sms_behavior, action, SendSms_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_sms_behavior, action, SendSms_SendGoal_Event)),
  }
};

typedef struct _SendSms_SendGoal_Event_type_support_data_t
{
  void * data[2];
} _SendSms_SendGoal_Event_type_support_data_t;

static _SendSms_SendGoal_Event_type_support_data_t _SendSms_SendGoal_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SendSms_SendGoal_Event_message_typesupport_map = {
  2,
  "nav2_sms_behavior",
  &_SendSms_SendGoal_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SendSms_SendGoal_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SendSms_SendGoal_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SendSms_SendGoal_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SendSms_SendGoal_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::nav2_sms_behavior::action::rosidl_typesupport_cpp::SendSms_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav2_sms_behavior, action, SendSms_SendGoal_Event)() {
  return get_message_type_support_handle<nav2_sms_behavior::action::SendSms_SendGoal_Event>();
}
...
static const rosidl_service_type_support_t SendSms_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav2_sms_behavior::action::SendSms_SendGoal_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav2_sms_behavior::action::SendSms_SendGoal_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav2_sms_behavior::action::SendSms_SendGoal_Event>(),
...
typedef struct _SendSms_GetResult_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SendSms_GetResult_Event_type_support_ids_t;

static const _SendSms_GetResult_Event_type_support_ids_t _SendSms_GetResult_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _SendSms_GetResult_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SendSms_GetResult_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SendSms_GetResult_Event_type_support_symbol_names_t _SendSms_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_sms_behavior, action, SendSms_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_sms_behavior, action, SendSms_GetResult_Event)),
  }
};

typedef struct _SendSms_GetResult_Event_type_support_data_t
{
  void * data[2];
} _SendSms_GetResult_Event_type_support_data_t;

static _SendSms_GetResult_Event_type_support_data_t _SendSms_GetResult_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SendSms_GetResult_Event_message_typesupport_map = {
  2,
  "nav2_sms_behavior",
  &_SendSms_GetResult_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SendSms_GetResult_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SendSms_GetResult_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SendSms_GetResult_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SendSms_GetResult_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::nav2_sms_behavior::action::rosidl_typesupport_cpp::SendSms_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav2_sms_behavior, action, SendSms_GetResult_Event)() {
  return get_message_type_support_handle<nav2_sms_behavior::action::SendSms_GetResult_Event>();
}
...
static const rosidl_service_type_support_t SendSms_GetResult_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_service_typesupport_handle_function,
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav2_sms_behavior::action::SendSms_GetResult_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav2_sms_behavior::action::SendSms_GetResult_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<nav2_sms_behavior::action::SendSms_GetResult_Event>(),
