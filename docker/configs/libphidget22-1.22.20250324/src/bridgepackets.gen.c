...
bridgepacketinfo_t bridgepacketinfo[] = {
	...
	{ "BP_MAXRESISTANCECHANGE", 0}, /* 0xc6 */
	{ "BP_SETSPICHIPSELECT", 0}, /* 0xc7 */
	{ "BP_SETIGNORERESPONSE", 0}, /* 0xc8 */
	{ "BP_WRITEWITHCHIPSET", BP_FLAG_NOFORWARD}, /* 0xc9 */
	{ "BP_IOVOLTAGECHANGE", 0}, /* 0xca */
	{ "BP_SETANIMATION", BP_FLAG_NOFORWARD}, /* 0xcb */
	{ "BP_SYNCHRONIZE", BP_FLAG_NOFORWARD}, /* 0xcc */
	{ "BP_SETGAMMA", 0}, /* 0xcd */
	{ "BP_SETBRIGHTNESS", 0}, /* 0xce */
	{ "BP_STOPANIMATION", BP_FLAG_NOFORWARD}, /* 0xcf */
	{ "BP_I2CDATAEXCHANGE", BP_FLAG_NOFORWARD}, /* 0xd0 */
	{ (void *)0, 0 }
};
