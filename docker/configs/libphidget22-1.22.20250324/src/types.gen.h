...
typedef enum {
	LED_PROTOCOL_RGB = 0x1,	/* Byte order RGB (WS2811) */
	LED_PROTOCOL_GRB = 0x2,	/* Byte order GRB (WS2812B, SK6812) */
	LED_PROTOCOL_RGBW = 0x3,	/* Byte order RGBW */
	LED_PROTOCOL_GRBW = 0x4,	/* Byte order GRBW (SK6812RGBW) */
