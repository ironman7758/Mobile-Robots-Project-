...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "EPHIDGET_BADCONNECTION") == 0)
		return (66);

	if (mos_strcasecmp(name, "EPHIDGET_NACK") == 0)
		return (67);
	...
	if (mos_strcasecmp(name, "PHIDID_DCC1020") == 0)
		return (128);

	if (mos_strcasecmp(name, "PHIDID_DCC1030") == 0)
		return (152);

	if (mos_strcasecmp(name, "PHIDID_DCC1100") == 0)
		return (108);

	if (mos_strcasecmp(name, "PHIDID_DCC1120") == 0)
		return (150);

	if (mos_strcasecmp(name, "PHIDID_DCC1130") == 0)
		return (154);
	...
	if (mos_strcasecmp(name, "PHIDCLASS_LEDARRAY") == 0)
		return (26);
	...
	if (mos_strcasecmp(name, "PHIDCHCLASS_LEDARRAY") == 0)
		return (40);
	...
	if (mos_strcasecmp(name, "DATAADAPTER_VOLTAGE_EXTERN") == 0)
		return (1);

	if (mos_strcasecmp(name, "DATAADAPTER_VOLTAGE_2_5V") == 0)
		return (3);

	if (mos_strcasecmp(name, "DATAADAPTER_VOLTAGE_3_3V") == 0)
		return (4);

	if (mos_strcasecmp(name, "DATAADAPTER_VOLTAGE_5_0V") == 0)
		return (5);
	...
	if (mos_strcasecmp(name, "INPUT_MODE_FLOATING") == 0)
		return (3);

	if (mos_strcasecmp(name, "INPUT_MODE_PULLUP") == 0)
		return (4);
	...
	if (mos_strcasecmp(name, "DRIVE_MODE_COAST") == 0)
		return (1);

	if (mos_strcasecmp(name, "DRIVE_MODE_FORCED") == 0)
		return (2);
	...
	if (mos_strcasecmp(name, "SENSOR_TYPE_VCP4115") == 0)
		return (41150);
	...
	if (mos_strcasecmp(name, "PROTOCOL_HID_GENERIC") == 0)
		return (4);

	if (mos_strcasecmp(name, "PROTOCOL_HID_H10301") == 0)
		return (5);

	if (mos_strcasecmp(name, "CHIPSET_T5577") == 0)
		return (1);

	if (mos_strcasecmp(name, "CHIPSET_EM4305") == 0)
		return (2);
	...
	if (mos_strcasecmp(name, "FREQUENCY_10kHz") == 0)
		return (1);

	if (mos_strcasecmp(name, "FREQUENCY_100kHz") == 0)
		return (2);

	if (mos_strcasecmp(name, "FREQUENCY_400kHz") == 0)
		return (3);

	if (mos_strcasecmp(name, "FREQUENCY_188kHz") == 0)
		return (4);

	if (mos_strcasecmp(name, "FREQUENCY_375kHz") == 0)
		return (5);

	if (mos_strcasecmp(name, "FREQUENCY_750kHz") == 0)
		return (6);

	if (mos_strcasecmp(name, "FREQUENCY_1500kHz") == 0)
		return (7);

	if (mos_strcasecmp(name, "FREQUENCY_3MHz") == 0)
		return (8);

	if (mos_strcasecmp(name, "FREQUENCY_6MHz") == 0)
		return (9);
	...
	if (mos_strcasecmp(name, "PACKET_ERROR_NACK") == 0)
		return (7);

	if (mos_strcasecmp(name, "SPI_CHIP_SELECT_ACTIVE_LOW") == 0)
		return (1);

	if (mos_strcasecmp(name, "SPI_CHIP_SELECT_ACTIVE_HIGH") == 0)
		return (2);

	if (mos_strcasecmp(name, "SPI_CHIP_SELECT_LOW") == 0)
		return (3);

	if (mos_strcasecmp(name, "SPI_CHIP_SELECT_HIGH") == 0)
		return (4);
	...
	if (mos_strcasecmp(name, "LED_PROTOCOL_RGB") == 0)
		return (1);

	if (mos_strcasecmp(name, "LED_PROTOCOL_GRB") == 0)
		return (2);

	if (mos_strcasecmp(name, "LED_PROTOCOL_RGBW") == 0)
		return (3);

	if (mos_strcasecmp(name, "LED_PROTOCOL_GRBW") == 0)
		return (4);

	if (mos_strcasecmp(name, "ANIMATION_TYPE_FORWARD_SCROLL") == 0)
		return (1);

	if (mos_strcasecmp(name, "ANIMATION_TYPE_REVERSE_SCROLL") == 0)
		return (2);

	if (mos_strcasecmp(name, "ANIMATION_TYPE_POPCORN") == 0)
		return (3);

	if (mos_strcasecmp(name, "ANIMATION_TYPE_FORWARD_SCROLL_MIRROR") == 0)
		return (4);

	if (mos_strcasecmp(name, "ANIMATION_TYPE_REVERSE_SCROLL_MIRROR") == 0)
		return (5);
...
Phidget_enumString(const char *family, int id) {
	...
	if (mos_strcasecmp(family, "DataAdapterVoltage") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "DriveMode") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "RFIDChipset") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "DataAdapterFrequency") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "DataAdapterSPIChipSelect") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "LEDArrayProtocol") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "LEDArrayAnimationType") == 0) {
		switch (id) {
		case 1:
...
int
supportedDataAdapterVoltage(PhidgetChannelHandle ch, Phidget_DataAdapterVoltage val) {
...
int
supportedDriveMode(PhidgetChannelHandle ch, Phidget_DriveMode val) {

	switch (ch->UCD->uid) {
	case PHIDCHUID_DCC1020_DCMOTOR_100:
		switch (val) {
		case DRIVE_MODE_COAST:
		case DRIVE_MODE_FORCED:
			return (1);
		default:
			return (0);
		}
...
int
supportedRFIDChipset(PhidgetChannelHandle ch, PhidgetRFID_Chipset val) {
...
int
supportedDataAdapterFrequency(PhidgetChannelHandle ch, PhidgetDataAdapter_Frequency val) {
...
int
supportedDataAdapterSPIChipSelect(PhidgetChannelHandle ch, PhidgetDataAdapter_SPIChipSelect val) {
...
int
supportedLEDArrayProtocol(PhidgetChannelHandle ch, PhidgetLEDArray_Protocol val) {
...
int
supportedLEDArrayAnimationType(PhidgetChannelHandle ch, PhidgetLEDArray_AnimationType val) {
