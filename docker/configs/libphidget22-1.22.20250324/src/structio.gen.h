...
PhidgetReturnCode readRGBW(BridgePacket *bp, PhidgetLEDArray_RGBWHandle dst);
PhidgetReturnCode writeRGBW(const PhidgetLEDArray_RGBWHandle src, BridgePacket *bp);
PhidgetReturnCode readAnimationDescription(BridgePacket *bp,
  PhidgetLEDArray_AnimationDescriptionHandle dst);
PhidgetReturnCode writeAnimationDescription(const PhidgetLEDArray_AnimationDescriptionHandle src,
  BridgePacket *bp);
