...
API_PRETURN_HDR PhidgetMotorVelocityController_setFailsafeBrakingEnabled(PhidgetMotorVelocityControllerHandle ch, int failsafeBrakingEnabled);
API_PRETURN_HDR PhidgetMotorVelocityController_getFailsafeBrakingEnabled(PhidgetMotorVelocityControllerHandle ch, int *failsafeBrakingEnabled);
