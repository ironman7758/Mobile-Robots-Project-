...
struct _PhidgetCapacitiveTouch {
	...
	volatile PhidgetCapacitiveTouch_OnTouchCallback Touch;
	volatile void *TouchCtx;
	volatile PhidgetCapacitiveTouch_OnTouchEndCallback TouchEnd;
	volatile void *TouchEndCtx;
};
...
_bridgeInput(PhidgetChannelHandle phid, BridgePacket *bp) {
	...
	case BP_TOUCHINPUTVALUECHANGE:
		...
		FIRECH(ch, PhidgetCapacitiveTouch, Touch, ch->touchValue);
		break;
	case BP_TOUCHINPUTEND:
		FIRECH0(ch, PhidgetCapacitiveTouch, TouchEnd);
		break;
	default:
