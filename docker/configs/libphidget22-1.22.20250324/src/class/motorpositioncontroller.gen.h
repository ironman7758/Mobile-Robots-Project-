...
API_PRETURN_HDR PhidgetMotorPositionController_getActiveCurrentLimit(PhidgetMotorPositionControllerHandle ch, double *activeCurrentLimit);
...
API_PRETURN_HDR PhidgetMotorPositionController_getEngaged(PhidgetMotorPositionControllerHandle ch,
  int *engaged);
API_PRETURN_HDR PhidgetMotorPositionController_getExpectedPosition(PhidgetMotorPositionControllerHandle ch, double *expectedPosition);
API_PRETURN_HDR PhidgetMotorPositionController_setEnableExpectedPosition(PhidgetMotorPositionControllerHandle ch, int enableExpectedPosition);
API_PRETURN_HDR PhidgetMotorPositionController_getEnableExpectedPosition(PhidgetMotorPositionControllerHandle ch, int *enableExpectedPosition);
API_PRETURN_HDR PhidgetMotorPositionController_setFailsafeBrakingEnabled(PhidgetMotorPositionControllerHandle ch, int failsafeBrakingEnabled);
API_PRETURN_HDR PhidgetMotorPositionController_getFailsafeBrakingEnabled(PhidgetMotorPositionControllerHandle ch, int *failsafeBrakingEnabled);
...
API_PRETURN_HDR PhidgetMotorPositionController_getFanMode(PhidgetMotorPositionControllerHandle ch,
  Phidget_FanMode *fanMode);
API_PRETURN_HDR PhidgetMotorPositionController_setInductance(PhidgetMotorPositionControllerHandle ch,
  double inductance);
API_PRETURN_HDR PhidgetMotorPositionController_getInductance(PhidgetMotorPositionControllerHandle ch,
  double *inductance);
API_PRETURN_HDR PhidgetMotorPositionController_getMinInductance(PhidgetMotorPositionControllerHandle ch,
  double *minInductance);
API_PRETURN_HDR PhidgetMotorPositionController_getMaxInductance(PhidgetMotorPositionControllerHandle ch,
...
API_PRETURN_HDR PhidgetMotorPositionController_getKp(PhidgetMotorPositionControllerHandle ch,
  double *kp);
API_PRETURN_HDR PhidgetMotorPositionController_setNormalizePID(PhidgetMotorPositionControllerHandle ch,
  int normalizePID);
API_PRETURN_HDR PhidgetMotorPositionController_getNormalizePID(PhidgetMotorPositionControllerHandle ch,
  int *normalizePID);
...
API_PRETURN_HDR PhidgetMotorPositionController_getMaxPosition(PhidgetMotorPositionControllerHandle ch,
  double *maxPosition);
API_PRETURN_HDR PhidgetMotorPositionController_setPositionType(PhidgetMotorPositionControllerHandle ch,
  Phidget_PositionType positionType);
API_PRETURN_HDR PhidgetMotorPositionController_getPositionType(PhidgetMotorPositionControllerHandle ch,
  Phidget_PositionType *positionType);
...
API_PRETURN_HDR PhidgetMotorPositionController_setSurgeCurrentLimit(PhidgetMotorPositionControllerHandle ch, double surgeCurrentLimit);
API_PRETURN_HDR PhidgetMotorPositionController_getSurgeCurrentLimit(PhidgetMotorPositionControllerHandle ch, double *surgeCurrentLimit);
API_PRETURN_HDR PhidgetMotorPositionController_getMinSurgeCurrentLimit(PhidgetMotorPositionControllerHandle ch, double *minSurgeCurrentLimit);
API_PRETURN_HDR PhidgetMotorPositionController_getMaxSurgeCurrentLimit(PhidgetMotorPositionControllerHandle ch, double *maxSurgeCurrentLimit);
...
API_PRETURN_HDR PhidgetMotorPositionController_setOnExpectedPositionChangeHandler(PhidgetMotorPositionControllerHandle ch, PhidgetMotorPositionController_OnExpectedPositionChangeCallback fptr, void *ctx);
