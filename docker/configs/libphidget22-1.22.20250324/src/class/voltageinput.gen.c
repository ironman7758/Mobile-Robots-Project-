...
struct _PhidgetVoltageInput {
	...
	volatile PhidgetVoltageInput_OnSensorChangeCallback SensorChange;
	volatile void *SensorChangeCtx;
	volatile PhidgetVoltageInput_OnVoltageChangeCallback VoltageChange;
	volatile void *VoltageChangeCtx;
};
