...
struct _PhidgetRCServo {
	...
	volatile PhidgetRCServo_OnPositionChangeCallback PositionChange;
	volatile void *PositionChangeCtx;
	volatile PhidgetRCServo_OnTargetPositionReachedCallback TargetPositionReached;
	volatile void *TargetPositionReachedCtx;
	volatile PhidgetRCServo_OnVelocityChangeCallback VelocityChange;
