...
struct _PhidgetStepper {
	...
	volatile PhidgetStepper_OnPositionChangeCallback PositionChange;
	volatile void *PositionChangeCtx;
	volatile PhidgetStepper_OnStoppedCallback Stopped;
	volatile void *StoppedCtx;
	volatile PhidgetStepper_OnVelocityChangeCallback VelocityChange;
