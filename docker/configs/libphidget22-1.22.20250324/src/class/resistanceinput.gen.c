...
struct _PhidgetResistanceInput {
	...
	volatile PhidgetResistanceInput_OnResistanceChangeCallback ResistanceChange;
	volatile void *ResistanceChangeCtx;
};
...
_bridgeInput(PhidgetChannelHandle phid, BridgePacket *bp) {
	...
	case BP_RESISTANCECHANGE:
		...
		FIRECH(ch, PhidgetResistanceInput, ResistanceChange, ch->resistance);
		break;
	default:
...
PhidgetResistanceInput_setOnResistanceChangeHandler(PhidgetResistanceInputHandle ch,
  PhidgetResistanceInput_OnResistanceChangeCallback fptr, void *ctx) {
	...
	MEMORY_BARRIER();
	if (fptr == NULL) {
		ch->ResistanceChange = NULL;
		MEMORY_BARRIER();
		ch->ResistanceChangeCtx = NULL;
	} else {
