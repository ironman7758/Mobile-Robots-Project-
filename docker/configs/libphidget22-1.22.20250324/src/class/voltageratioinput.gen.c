...
struct _PhidgetVoltageRatioInput {
	...
	volatile PhidgetVoltageRatioInput_OnSensorChangeCallback SensorChange;
	volatile void *SensorChangeCtx;
	volatile PhidgetVoltageRatioInput_OnVoltageRatioChangeCallback VoltageRatioChange;
	volatile void *VoltageRatioChangeCtx;
};
