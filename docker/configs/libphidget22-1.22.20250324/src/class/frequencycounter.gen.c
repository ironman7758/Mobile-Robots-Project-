...
struct _PhidgetFrequencyCounter {
	...
	double timeElapsed;
	volatile PhidgetFrequencyCounter_OnCountChangeCallback CountChange;
	volatile void *CountChangeCtx;
	volatile PhidgetFrequencyCounter_OnFrequencyChangeCallback FrequencyChange;
	volatile void *FrequencyChangeCtx;
};
