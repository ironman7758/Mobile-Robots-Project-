...
struct _PhidgetDCMotor {
	...
	double minVelocity;
	double maxVelocity;
	volatile PhidgetDCMotor_OnBackEMFChangeCallback BackEMFChange;
	volatile void *BackEMFChangeCtx;
	volatile PhidgetDCMotor_OnBrakingStrengthChangeCallback BrakingStrengthChange;
	volatile void *BrakingStrengthChangeCtx;
	volatile PhidgetDCMotor_OnVelocityUpdateCallback VelocityUpdate;
