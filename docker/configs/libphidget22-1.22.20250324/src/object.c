...
void phidget_init(PhidgetHandle phid, PhidgetStructType type, PhidgetDelete_t _delete) {
...
void PhidgetRunLock(void *_phid) {
	PhidgetHandle phid;
...
void PhidgetRunUnlock(void *_phid) {
	PhidgetHandle phid;
...
void PhidgetDeviceMemberLock(PhidgetDeviceHandle phid) {

	MOS_ASSERT(phid != NULL);
	mos_tlock_lock(phid->__memberlock);
}

void PhidgetDeviceMemberUnlock(PhidgetDeviceHandle phid) {

	MOS_ASSERT(phid != NULL);
	mos_tlock_unlock(phid->__memberlock);
}
void PhidgetWait(void *_phid) {
	PhidgetHandle phid;
...
void PhidgetBroadcast(void *_phid) {
	PhidgetHandle phid;
...
void PhidgetRelease(void *_phid) {
	PhidgetHandle phid;
